...
res = [SGDRegressor(), Ridge(max_iter=20000), SVR(max_iter=20000),
       KNeighborsRegressor(),
...
if __name__ == '__main__':
    for fx in FX_LIST:
        path_f_final = ['%s/%s_MON_f_new.npy' % (FILE_PREX, fx),
                        '%s/%s_MON_t_new.pkl.npy' % (FILE_PREX, fx)]
    ...
    result.to_pickle('../data/fx/result_compere_re_month_new.pkl')
